...
// Function: ldv_smi_ipmb_proc_ops_release
// with type: int ldv_smi_ipmb_proc_ops_release()
// with return type: int
int __VERIFIER_nondet_int(void);
...
// Function: ldv_smi_stats_proc_ops_release
// with type: int ldv_smi_stats_proc_ops_release()
// with return type: int
int __VERIFIER_nondet_int(void);
...
// Function: ldv_smi_version_proc_ops_release
// with type: int ldv_smi_version_proc_ops_release()
// with return type: int
int __VERIFIER_nondet_int(void);
