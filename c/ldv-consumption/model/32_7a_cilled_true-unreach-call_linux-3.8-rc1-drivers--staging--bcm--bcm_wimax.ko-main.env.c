...
// Function: filp_close
// with type: int filp_close(struct file *, fl_owner_t )
// with return type: int
int __VERIFIER_nondet_int(void);
...
// Function: ldv_bcmNetDevOps_ndo_init_3
// with type: int ldv_bcmNetDevOps_ndo_init_3()
// with return type: int
int __VERIFIER_nondet_int(void);
int ldv_bcmNetDevOps_ndo_init_3() {
  // Simple type
  return __VERIFIER_nondet_int();
}

// Function: ldv_bcmNetDevOps_ndo_uninit_3
// with type: int ldv_bcmNetDevOps_ndo_uninit_3()
// with return type: int
int __VERIFIER_nondet_int(void);
int ldv_bcmNetDevOps_ndo_uninit_3() {
  // Simple type
  return __VERIFIER_nondet_int();
}

// Function: ldv_usbbcm_driver_reset_resume_4
// with type: int ldv_usbbcm_driver_reset_resume_4()
// with return type: int
int __VERIFIER_nondet_int(void);
int ldv_usbbcm_driver_reset_resume_4() {
  // Simple type
  return __VERIFIER_nondet_int();
}
...
// Function: vfs_llseek
// with type: loff_t vfs_llseek(struct file *, loff_t , int)
// with return type: loff_t 
long __VERIFIER_nondet_long(void);
loff_t vfs_llseek(struct file *arg0, loff_t arg1, int arg2) {
  // Typedef type
  // Real type: __kernel_loff_t 
  // Typedef type
  // Real type: long long
