...
// Function: ldv_driver_template_probe_1
// with type: int ldv_driver_template_probe_1()
...
// Function: scsi_register
// with type: struct Scsi_Host *scsi_register(struct scsi_host_template *, int)
