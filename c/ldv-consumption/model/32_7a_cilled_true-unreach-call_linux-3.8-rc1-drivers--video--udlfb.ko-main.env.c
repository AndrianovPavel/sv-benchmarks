...
// Function: ldv_dlfb_ops_probe_3
// with type: int ldv_dlfb_ops_probe_3()
// with return type: int
int __VERIFIER_nondet_int(void);
...
// Function: ldv_dlfb_ops_release_3
// with type: int ldv_dlfb_ops_release_3()
// with return type: int
int __VERIFIER_nondet_int(void);
...
// Function: ldv_edid_attr_probe_2
// with type: int ldv_edid_attr_probe_2()
// with return type: int
int __VERIFIER_nondet_int(void);
...
// Function: ldv_edid_attr_release_2
// with type: int ldv_edid_attr_release_2()
// with return type: int
int __VERIFIER_nondet_int(void);
