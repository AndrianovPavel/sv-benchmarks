...
// Function: ldv_cciss_dev_type_probe_2
// with type: int ldv_cciss_dev_type_probe_2()
// with return type: int
int __VERIFIER_nondet_int(void);
...
// Function: ldv_cciss_host_type_probe_3
// with type: int ldv_cciss_host_type_probe_3()
// with return type: int
int __VERIFIER_nondet_int(void);
