...
// Function: ldv_edid1_attr_probe_4
// with type: int ldv_edid1_attr_probe_4()
// with return type: int
int __VERIFIER_nondet_int(void);
int ldv_edid1_attr_probe_4() {
  // Simple type
  return __VERIFIER_nondet_int();
}

// Function: ldv_edid1_attr_release_4
// with type: int ldv_edid1_attr_release_4()
// with return type: int
int __VERIFIER_nondet_int(void);
int ldv_edid1_attr_release_4() {
  // Simple type
  return __VERIFIER_nondet_int();
}

// Function: ldv_edid2_attr_probe_3
// with type: int ldv_edid2_attr_probe_3()
// with return type: int
int __VERIFIER_nondet_int(void);
int ldv_edid2_attr_probe_3() {
  // Simple type
  return __VERIFIER_nondet_int();
}

// Function: ldv_edid2_attr_release_3
// with type: int ldv_edid2_attr_release_3()
// with return type: int
int __VERIFIER_nondet_int(void);
int ldv_edid2_attr_release_3() {
  // Simple type
  return __VERIFIER_nondet_int();
}
