...
// Function: input_scancode_to_scalar
// with type: int input_scancode_to_scalar(const struct input_keymap_entry *, unsigned int *)
// with return type: int
int __VERIFIER_nondet_int(void);
...
// with type: int ldv_rc_dev_type_probe_1()
// with return type: int
int __VERIFIER_nondet_int(void);
