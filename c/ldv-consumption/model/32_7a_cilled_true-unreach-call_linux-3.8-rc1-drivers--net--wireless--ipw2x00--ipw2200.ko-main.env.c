...
// Function: ldv_ipw_netdev_ops_ndo_init_2
// with type: int ldv_ipw_netdev_ops_ndo_init_2()
// with return type: int
int __VERIFIER_nondet_int(void);
...
// Function: ldv_ipw_netdev_ops_ndo_uninit_2
// with type: int ldv_ipw_netdev_ops_ndo_uninit_2()
// with return type: int
int __VERIFIER_nondet_int(void);
...
// Function: ldv_ipw_prom_netdev_ops_ndo_init_3
// with type: int ldv_ipw_prom_netdev_ops_ndo_init_3()
// with return type: int
int __VERIFIER_nondet_int(void);
...
// Function: ldv_ipw_prom_netdev_ops_ndo_uninit_3
// with type: int ldv_ipw_prom_netdev_ops_ndo_uninit_3()
// with return type: int
int __VERIFIER_nondet_int(void);
