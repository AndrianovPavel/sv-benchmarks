...
{ int i ;
  ...
  goto ldv_45389;
  ldv_45388: ;
  if ((unsigned long )image->sec[i].data == (unsigned long )((void const   */* const  */)0)) {
    goto ldv_45387;
  } else {
...
#include "model/32_7a_cilled_true-unreach-call_linux-3.8-rc1-drivers--net--wireless--iwlwifi--iwlwifi.ko-main.env.c"
