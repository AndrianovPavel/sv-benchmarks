...
extern unsigned long long int __VERIFIER_nondet_ulonglong();
extern unsigned long int __VERIFIER_nondet_ulong();
extern unsigned short int __VERIFIER_nondet_ushort();
...
int main(void)
{
  ...
  int tmp ;
  int tmp___0 ;
  struct net_device *net_device_p1 = ldv_successful_malloc(sizeof(struct net_device));
  var_group1 = net_device_p1;
  struct ethtool_cmd *ethtool_cmd_p1 = ldv_successful_malloc(sizeof(struct ethtool_cmd));
  var_group2 = ethtool_cmd_p1;
  struct ethtool_drvinfo *ethtool_drvinfo_p1 = ldv_successful_malloc(sizeof(struct ethtool_drvinfo));
  var_group3 = ethtool_drvinfo_p1;
  var_batadv_set_msglevel_18_p1 = __VERIFIER_nondet_uint();
  var_batadv_get_strings_20_p1 = __VERIFIER_nondet_uint();
  uint8_t *uint8_t_p1 = ldv_successful_malloc(sizeof(uint8_t));
  *(uint8_t_p1) = __VERIFIER_nondet_uchar();
  var_batadv_get_strings_20_p2 = uint8_t_p1;
  struct ethtool_stats *ethtool_stats_p1 = ldv_successful_malloc(sizeof(struct ethtool_stats));
  var_group4 = ethtool_stats_p1;
  uint64_t *uint64_t_p1 = ldv_successful_malloc(sizeof(uint64_t));
  *(uint64_t_p1) = __VERIFIER_nondet_ulonglong();
  var_batadv_get_ethtool_stats_21_p2 = uint64_t_p1;
  var_batadv_get_sset_count_22_p1 = __VERIFIER_nondet_int();
  res_batadv_softif_init_10 = __VERIFIER_nondet_int();
  res_batadv_interface_open_1 = __VERIFIER_nondet_int();
  res_batadv_interface_release_2 = __VERIFIER_nondet_int();
  struct sockaddr *sockaddr_p1 = ldv_successful_malloc(sizeof(struct sockaddr));
  var_batadv_interface_set_mac_addr_4_p1 = sockaddr_p1;
  var_batadv_interface_change_mtu_5_p1 = __VERIFIER_nondet_int();
  struct sk_buff *sk_buff_p1 = ldv_successful_malloc(sizeof(struct sk_buff));
  var_group5 = sk_buff_p1;
  ldv_s_batadv_netdev_ops_net_device_ops = __VERIFIER_nondet_int();
  net_device_p1->flags = __VERIFIER_nondet_uint();
  net_device_p1->mtu = __VERIFIER_nondet_uint();
  net_device_p1->addr_assign_type = __VERIFIER_nondet_uchar();
  spinlock_t *spinlock_t_p1 = ldv_successful_malloc(sizeof(spinlock_t));
  net_device_p1->addr_list_lock = *(spinlock_t_p1);
  net_device_p1->last_rx = __VERIFIER_nondet_ulong();
  unsigned char *char_p1 = ldv_successful_malloc(sizeof(unsigned char));
  *(char_p1) = __VERIFIER_nondet_uchar();
  net_device_p1->dev_addr = char_p1;
  struct netdev_queue *netdev_queue_p1 = ldv_successful_malloc(sizeof(struct netdev_queue));
  net_device_p1->_tx = netdev_queue_p1;
  net_device_p1->num_tx_queues = __VERIFIER_nondet_uint();
  net_device_p1->trans_start = __VERIFIER_nondet_ulong();
  ethtool_cmd_p1->supported = __VERIFIER_nondet_uint();
  ethtool_cmd_p1->advertising = __VERIFIER_nondet_uint();
  ethtool_cmd_p1->speed = __VERIFIER_nondet_ushort();
  ethtool_cmd_p1->duplex = __VERIFIER_nondet_uchar();
  ethtool_cmd_p1->port = __VERIFIER_nondet_uchar();
  ethtool_cmd_p1->phy_address = __VERIFIER_nondet_uchar();
  ethtool_cmd_p1->transceiver = __VERIFIER_nondet_uchar();
  ethtool_cmd_p1->autoneg = __VERIFIER_nondet_uchar();
  ethtool_cmd_p1->maxtxpkt = __VERIFIER_nondet_uint();
  ethtool_cmd_p1->maxrxpkt = __VERIFIER_nondet_uint();
  ethtool_cmd_p1->speed_hi = __VERIFIER_nondet_ushort();
  sk_buff_p1->dev = net_device_p1;
  sk_buff_p1->len = __VERIFIER_nondet_uint();
  sk_buff_p1->priority = __VERIFIER_nondet_uint();
  sk_buff_p1->protocol = __VERIFIER_nondet_ushort();
  sk_buff_p1->skb_iif = __VERIFIER_nondet_int();
  sk_buff_p1->network_header = __VERIFIER_nondet_uint();
  sk_buff_p1->mac_header = __VERIFIER_nondet_uint();
  sk_buff_p1->tail = __VERIFIER_nondet_uint();
  unsigned char *char_p2 = ldv_successful_malloc(sizeof(unsigned char));
  *(char_p2) = __VERIFIER_nondet_uchar();
  sk_buff_p1->data = char_p2;
  union __anonunion_ldv_5961_28 *__anonunion_ldv_5961_28_p1 = ldv_successful_malloc(sizeof(union __anonunion_ldv_5961_28));
  spinlock_t_p1->ldv_5961 = *(__anonunion_ldv_5961_28_p1);
  netdev_queue_p1->_xmit_lock = *(spinlock_t_p1);
  netdev_queue_p1->state = __VERIFIER_nondet_ulong();
  struct raw_spinlock *raw_spinlock_p1 = ldv_successful_malloc(sizeof(struct raw_spinlock));
  __anonunion_ldv_5961_28_p1->rlock = *(raw_spinlock_p1);
  struct __anonstruct_ldv_5960_29 *__anonstruct_ldv_5960_29_p1 = ldv_successful_malloc(sizeof(struct __anonstruct_ldv_5960_29));
  __anonunion_ldv_5961_28_p1->ldv_5960 = *(__anonstruct_ldv_5960_29_p1);
  struct lockdep_map *lockdep_map_p1 = ldv_successful_malloc(sizeof(struct lockdep_map));
  __anonstruct_ldv_5960_29_p1->dep_map = *(lockdep_map_p1);
  {
  ...
  free(char_p1);
  free(ethtool_cmd_p1);
  free(netdev_queue_p1);
  free(net_device_p1);
  free(raw_spinlock_p1);
  free(ethtool_drvinfo_p1);
  free(sockaddr_p1);
  free(ethtool_stats_p1);
  free(sk_buff_p1);
  free(uint8_t_p1);
  free(__anonunion_ldv_5961_28_p1);
  free(__anonstruct_ldv_5960_29_p1);
  free(spinlock_t_p1);
  return 0;
}
}
