...
{ int tmp ;
  ...
  return (87);
  case 2: ;
  if ((unsigned long )e->arpq_head != (unsigned long )((struct sk_buff */* const  */)0)) {
    tmp = 65;
  } else {
    tmp = 82;
  }
...
#include "model/32_7a_cilled_true-unreach-call_linux-3.8-rc1-drivers--net--ethernet--chelsio--cxgb4--cxgb4.ko-main.env.c"
