                                   ...
                                   struct libipw_rx_stats *stats )
{
  ...
  if ((priv->config & 4096U) != 0U) {
    ...
    if (__len > 63UL) {
      ...
      __ret = __builtin_memcpy((void *)tmp___2, (void const *)stats, __len);
    }
  ...
  *(txq->txb + (unsigned long )q->first_empty) = txb;
  ...
  if ((int )txb->nr_frags != i) {
    ...
    if ((unsigned long )skb != (unsigned long )((struct sk_buff *)0)) {
      ...
      __ret___0 = __builtin_memcpy((void *)tmp___11, (void const *)(txb->fragments[j])->data + (unsigned long )hdr_len,
                                   __len___0);
      j = j + 1;
      ldv_48611: ;
      if ((int )txb->nr_frags > j) {
